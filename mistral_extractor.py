...
{{
  ...
  "project": {{
    ...
    "architect_firm": "name of the architecture studio or firm (e.g. M+M Arquitectos), or null if not found",
    "architect": "individual architect or designer contact name",
